...
export function getBlogByUid (params) {
  return request({
    url: process.env.ARTICLE_API + '/content/getBlogByUid',
    method: 'get',
    params
  })
}
...
export function getSameBlogByTagUid (params) {
  return request({
    url: process.env.ARTICLE_API + '/content/getSameBlogByTagUid',
    method: 'get',
    params
  })
}
...
export function getSameBlogByBlogUid (params) {
  return request({
    url: process.env.ARTICLE_API + '/content/getSameBlogByBlogUid',
    method: 'get',
    params
  })
}
...
export function praiseBlogByUid (params) {
  return request({
    url: process.env.ARTICLE_API + '/content/praiseBlogByUid',
    method: 'get',
    params
  })
}
